          ...
          <div className="bg-white border border-slate-200/80 rounded-2xl p-3.5 sm:p-4 shadow-2xs flex items-center gap-3.5">
            ...
            <div className="flex flex-col min-w-0">
              ...
              <div className="flex items-baseline gap-2">
                <span className="text-xs sm:text-sm font-extrabold text-slate-900">5 / 5</span>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white border border-slate-200/80 rounded-2xl p-4 shadow-2xs flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3 w-full sm:w-auto">
                ...
                <Button
                  className="bg-[#059669] hover:bg-[#047857] text-white font-bold text-xs h-11 px-6 rounded-xl shadow-2xs hover:shadow-md transition-all flex items-center gap-2 flex-1 sm:flex-initial justify-center"
                  disabled={submitting}
                  onClick={submit}
                >
...
function PhotoPreview({ file, onRemove }: { file: File; onRemove: () => void }) {
  ...
  return (
    <div className="relative group aspect-square rounded-xl overflow-hidden border border-slate-200 bg-slate-100 shadow-2xs">
      <img className="size-full object-cover transition-transform group-hover:scale-105" src={src} alt="Bin photo preview" />
      <button
        type="button"
        onClick={onRemove}
